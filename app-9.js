...
(()=>{
 ...
 style.textContent='.logo.logo-image{display:flex;align-items:center;letter-spacing:0;text-transform:none}.logo.logo-image img{display:block;width:auto;height:clamp(24px,2.15vw,31px);max-width:min(190px,32vw);object-fit:contain}.foot-brand{flex-direction:column;align-items:flex-start;gap:6px;flex-wrap:nowrap;text-align:left}';
